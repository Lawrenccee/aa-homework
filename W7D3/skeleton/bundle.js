...
exports.fetchSearchGiphys = exports.REQUEST_SEARCH_GIPHYS = exports.receiveSearchGiphys = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    ...
    giphys.map(function (giphy) {
      return _react2.default.createElement(_giphys_index_item2.default, { giphy: giphy, key: giphy.images.fixed_height.url });
    })
  );
};
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(event) {
      event.preventDefault();
      var searchItem = this.state.searchItem.split(' ').join('+');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('input', { onChange: this.handleChange, type: 'text', value: this.state.searchTerm }),
          _react2.default.createElement('input', { onClick: this.handleSubmit, type: 'submit', value: 'Search' })
        ),
...
var _ponyfill = __webpack_require__(216);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(104), __webpack_require__(217)(module)))
