...
var configureStore = function configureStore() {
  ...
  var store = (0, _redux.createStore)(_root_reducer2.default, preloadedState, (0, _redux.applyMiddleware)(extraMiddleWare, addLoggingToDispatch));
...
var extraMiddleWare = function extraMiddleWare(store) {
  return function (next) {
    return function (action) {
      console.log(next);
      next(action);
